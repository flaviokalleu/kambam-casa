...
const genres = ["Todos", "Ação", "Drama", "Ficção Científica", "Suspense", "Fantasia", "Terror", "Comédia"];
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="pl-64 transition-all duration-300">
        <header className="sticky top-0 z-40 bg-background/80 backdrop-blur-xl border-b border-border">
          <div className="flex items-center justify-between px-8 py-4">
            ...
            <div className="relative">
              ...
              <input type="text" placeholder="Buscar filme..." value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} className="w-64 pl-10 pr-4 py-2 rounded-lg bg-muted/50 border border-border text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/50" />
            </div>
          </div>
        </header>
        ...
        <div className="p-8">
          ...
          {filtered.length === 0 && <p className="text-center text-muted-foreground py-16">Nenhum filme encontrado</p>}
        </div>
      </main>
